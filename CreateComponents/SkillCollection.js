...
class SkillCollection extends Component { //TODO: Introduce a way to tell the player how many available skill points they have at any given level.
 state = {
          ...
          <ScrollView>
            <View style={styles.container}>
              <Skill
                name="Athletics"
                skill="athletics"
                attr={this.props.attributes.strength.score}
              ...
              <Skill
                name="Acrobatics"
                skill="acrobatics"
                attr={this.props.attributes.dexterity.score}
              ...
              <Skill
                name="Bluff"
                skill="bluff"
                attr={this.props.attributes.influence.score}
              ...
              <Skill
                name="Chemistry"
                skill="chemistry"
                attr={this.props.attributes.intelligence.score}
              ...
              <Skill
                name="Cooking"
                skill="cooking"
                attr={this.props.attributes.wisdom.score}
              ...
              <Skill
                name="Endurance"
                skill="endurance"
                attr={this.props.attributes.constitution.score}
