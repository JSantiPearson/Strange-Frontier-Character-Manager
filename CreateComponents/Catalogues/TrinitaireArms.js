...
import { View, Button, Text, Picker, TouchableOpacity, TextInput, StyleSheet, ScrollView, SafeAreaView, FlatList} from 'react-native'
    ...
    return (
      <>
        <SafeAreaView style={styles.container}>
          <Text style={styles.text}>Ranged Equipment</Text>
          <FlatList
            data={RANGED}
        ...
        {/*
          ...
          <FlatList
            ...
            keyExtractor={item => item.id}
          />
          <Text style={styles.text}>Gear and Equipment</Text>
          <FlatList
            data={ITEMS}
            renderItem={({item}) => this.renderItem(item)}
            keyExtractor={item => item.id}
