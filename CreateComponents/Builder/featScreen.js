...
const DATA = [
  ...
  { //TODO: Finish this feat once Tristan gets back to you on it
		name: "Crushing Counter",
    key:  "Crushing Counter",
  ...
  { /* TODO: This feat is dynamic, so wording may change */
    key: "Sneak Attack",
		name: "Sneak Attack",
...
class Feats extends PureComponent {
  ...
  renderFeat = ( feat ) => {
    return(
      <>
        <Feat {...this.props} addFeat={this.addFeat} feat={feat} />
      </>
    )
  }
     ...
     return (
       <>
        <SafeAreaView style={styles.container}>
          ...
          <FlatList
            data={DATA}
            renderItem={({item}) => this.renderFeat(item)}
